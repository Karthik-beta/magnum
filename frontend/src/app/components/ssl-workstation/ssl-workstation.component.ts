...
@Component({
  selector: 'app-ssl-workstation',
  templateUrl: './ssl-workstation.component.html',
  styleUrls: ['./ssl-workstation.component.scss']
})
export class SslWorkstationComponent implements OnInit {
