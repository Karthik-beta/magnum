...
@Component({
  selector: 'app-solo-plant',
  templateUrl: './solo-plant.component.html',
  styleUrls: ['./solo-plant.component.scss']
})
export class SoloPlantComponent implements OnInit{
    ...
    singleMachineList = [
        {
            ...
            assemblyline: 'Line 2',
            machine_id: 'MVD Shearing Machine',
            start_prod: '2024-09-17, 08 - 20 (11)',
            end_prod: '2024-09-17, 22 - 06 (8)',
            state: 'ACTIVE',
            activity: 78,
            product_id: 'PB Walkway',
            lot_batch: 'TEST'
        },
    ]
