...
@Component({
  selector: 'app-line-plan-actual-wipro',
  templateUrl: './line-plan-actual-wipro.component.html',
  styleUrls: ['./line-plan-actual-wipro.component.scss']
})
export class LinePlanActualWiproComponent implements OnInit {
