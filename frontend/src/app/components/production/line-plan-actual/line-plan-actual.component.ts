...
@Component({
  selector: 'app-line-plan-actual',
  templateUrl: './line-plan-actual.component.html',
  styleUrls: ['./line-plan-actual.component.scss']
})
export class LinePlanActualComponent implements OnInit {
