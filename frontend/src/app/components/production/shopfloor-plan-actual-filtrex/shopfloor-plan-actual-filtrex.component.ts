...
@Component({
  selector: 'app-shopfloor-plan-actual-filtrex',
  templateUrl: './shopfloor-plan-actual-filtrex.component.html',
  styleUrls: ['./shopfloor-plan-actual-filtrex.component.scss']
})
export class ShopfloorPlanActualFiltrexComponent implements OnInit {
