...
@Component({
  selector: 'app-line-plan-actual-ge',
  templateUrl: './line-plan-actual-ge.component.html',
  styleUrls: ['./line-plan-actual-ge.component.scss']
})
export class LinePlanActualGeComponent implements OnInit {
