...
@Component({
  selector: 'app-line-performance-filtrex',
  templateUrl: './line-performance-filtrex.component.html',
  styleUrls: ['./line-performance-filtrex.component.scss']
})
export class LinePerformanceFiltrexComponent implements OnInit {
