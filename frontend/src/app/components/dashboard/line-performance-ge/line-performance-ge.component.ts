...
@Component({
  selector: 'app-line-performance-ge',
  templateUrl: './line-performance-ge.component.html',
  styleUrls: ['./line-performance-ge.component.scss']
})
export class LinePerformanceGeComponent implements OnInit {
