...
@Component({
  selector: 'app-digital-quality-inspection',
  templateUrl: './digital-quality-inspection.component.html',
  styleUrls: ['./digital-quality-inspection.component.scss']
})
export class DigitalQualityInspectionComponent implements OnInit {
