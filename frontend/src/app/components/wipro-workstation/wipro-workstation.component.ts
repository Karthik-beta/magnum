...
@Component({
  selector: 'app-wipro-workstation',
  templateUrl: './wipro-workstation.component.html',
  styleUrls: ['./wipro-workstation.component.scss']
})
export class WiproWorkstationComponent implements OnInit {
