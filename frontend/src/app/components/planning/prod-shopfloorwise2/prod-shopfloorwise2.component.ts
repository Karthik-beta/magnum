...
@Component({
  selector: 'app-prod-shopfloorwise2',
  templateUrl: './prod-shopfloorwise2.component.html',
  styleUrls: ['./prod-shopfloorwise2.component.scss']
})
export class ProdShopfloorwise2Component implements OnInit {
    ...
    loadShopfloorStatus() {
        this.service.getShopfloorStatus2().subscribe(data=>{
    ...
    exportExcel(): void {
        ...
        this.service.downloadShopfloorStatus2(params).subscribe((response: any) => {
