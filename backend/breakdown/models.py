...
class AndonData(models.Model):
    ...
    company = models.CharField(max_length=100, default='SKF')
    location = models.CharField(max_length=100, default='BLR')
    shopfloor = models.CharField(max_length=300, default='GRINDING')
    assemblyline = models.CharField(max_length=300)
    machineId = models.CharField(max_length=50)
    category = models.CharField(max_length=50, blank=True, null=True)
    sub_category = models.CharField(max_length=50, blank=True, null=True)
    alert_shift = models.CharField(max_length=100)
