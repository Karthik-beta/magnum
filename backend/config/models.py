...
class ShiftTiming(models.Model):
    ...
    tea_break_1_start = models.TimeField(blank=True, null=True)
    tea_break_1_end = models.TimeField(blank=True, null=True)
    tea_break_2_start = models.TimeField(blank=True, null=True)
    tea_break_2_end = models.TimeField(blank=True, null=True)
    tea_break_3_start = models.TimeField(blank=True, null=True)
    tea_break_3_end = models.TimeField(blank=True, null=True)
    cleaning_start_time = models.TimeField(blank=True, null=True)
    cleaning_end_time = models.TimeField(blank=True, null=True)
    spell_downtime = models.DurationField(blank=True, null=True)
